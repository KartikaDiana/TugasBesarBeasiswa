      ...
      <div className="dashboard">
        ...
        <div className="main-content">
          ...
          <div className="content">
            <table className="datapendaftar-table">
              <thead>
                <tr>
                  <th>No.</th>
                  <th>Nama</th>
        ...
        <style>
          {`
            * {
            ...
            .datapendaftar-table th, .datapendaftar-table td {
              padding: 15px;
              text-align: left;
              border-bottom: 1px solid #ddd;
            }

            .datapendaftar-table th {
              background-color: #f4f4f4;
              color: #333;
              font-weight: bold;
            }

            .datapendaftar-table tr:nth-child(even) {
              background-color: #f9f9f9;
            }

            .datapendaftar-table tr:hover {
