...
const IdentitasDiri = () => {
  ...
  return (
    <>
      ...
      <Container>
        <Header>RIWAYAT AKADEMIK</Header>
        <MainContent>
          <Menu>
          ...
          <Content>
            <form action="submit_pendaftaran.html" method="post">
              <FormGroup>
                <label htmlFor="nilai-raport">Nilai Raport</label>
                <input
                  type="text"
                  id="nilai-raport"
                  name="nilai-raport"
                  placeholder="Masukkan rata-rata nilai raport"
                  required
                />
              </FormGroup>
              <FormGroup>
                <label htmlFor="upload-raport">Upload Nilai Raport</label>
                <input type="file" id="upload-raport" name="upload-raport" required />
              </FormGroup>
              <FormGroup>
                <label htmlFor="nilai-ipk">Nilai IPK</label>
                <input
                  type="text"
                  id="nilai-ipk"
                  name="nilai-ipk"
              ...
              <FormGroup>
                <label htmlFor="upload-transkrip">Upload Transkip Nilai</label>
                <input type="file" id="upload-transkrip" name="upload-transkrip" required />
              </FormGroup>
