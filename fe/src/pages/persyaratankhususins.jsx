      ...
      <Container>
        ...
        <MainContent>
          <Menu>
            ...
            <a href="persyaratankhususaff"><button>Persyaratan Khusus</button></a>
          ...
          <Content>
            <form action="submit_pendaftaran.html" method="post">
              <FormGroup>
                <label htmlFor="upload-SKTM">Sertifikat Lomba Internasional</label>
                <input type="file" id="upload-SKTM" name="upload-SKTM" required />
              </FormGroup>
              <FormGroup>
                <label htmlFor="upload-SPPO">Sertifikat Lomba Nasional</label>
                <input type="file" id="upload-SPPO" name="upload-SPPO" required />
              </FormGroup>
              <FormGroup>
                <label htmlFor="upload-Essai">Essai</label>
                <input type="file" id="upload-Essai" name="upload-Essai" required />
              </FormGroup>
